			...
			>
				...
				<defs>
					...
					>
						...
						<feColorMatrix
							type="matrix"
							values="0 0 0 0 0.388451 0 0 0 0 0.459239 0 0 0 0 0.484722 0 0 0 0.8 0"
						/>
						<feBlend
							mode="normal"
			...
			>
				<g filter="url(#filter0_d_1_85)">
					<path
						fill-rule="evenodd"
						clip-rule="evenodd"
						d="M21 3C18.7909 3 17 4.79086 17 7C17 9.20914 18.7909 11 21 11H29C31.2091 11 33 9.20914 33 7C33 4.79086 31.2091 3 29 3H21ZM14 7.00015H11C8.79086 7.00015 7 8.79101 7 11.0002V39.0002C7 41.2093 8.79086 43.0002 11 43.0002H39C41.2091 43.0002 43 41.2093 43 39.0002V11.0002C43 8.79101 41.2091 7.00015 39 7.00015H36C36 10.8661 32.866 14.0002 29 14.0002H21C17.134 14.0002 14 10.8661 14 7.00015ZM16.25 19C16.25 18.5858 16.5858 18.25 17 18.25H33C33.4142 18.25 33.75 18.5858 33.75 19C33.75 19.4142 33.4142 19.75 33 19.75H17C16.5858 19.75 16.25 19.4142 16.25 19ZM17 26.25C16.5858 26.25 16.25 26.5858 16.25 27C16.25 27.4142 16.5858 27.75 17 27.75H33C33.4142 27.75 33.75 27.4142 33.75 27C33.75 26.5858 33.4142 26.25 33 26.25H17ZM16.25 35C16.25 34.5858 16.5858 34.25 17 34.25H25C25.4142 34.25 25.75 34.5858 25.75 35C25.75 35.4142 25.4142 35.75 25 35.75H17C16.5858 35.75 16.25 35.4142 16.25 35Z"
						fill="white"
					/>
				</g>
				<defs>
					...
					>
						...
						<feBlend
							mode="normal"
							in2="BackgroundImageFix"
							result="effect1_dropShadow_1_85"
						/>
						<feBlend
							mode="normal"
							in="SourceGraphic"
							in2="effect1_dropShadow_1_85"
							result="shape"
						/>
					</filter>
				</defs>
